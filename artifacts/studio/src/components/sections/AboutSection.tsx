        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24">
          ...
          <div className="md:col-span-4 flex flex-col justify-between">
            ...
            <div className="mt-8 md:mt-0">
              <h3 className="font-serif italic text-4xl text-white mb-2">The Agency</h3>
              <p className="font-mono text-sm text-primary uppercase tracking-widest">Built for Indian Business</p>
            </div>
          </div>
          ...
          <div ref={textRef} className="md:col-span-8 flex flex-col justify-center">
            <div className="space-y-8 font-sans font-light text-xl md:text-2xl text-muted-foreground leading-relaxed">
              ...
              <p className="reveal-up text-sm text-white/40 font-mono uppercase tracking-wider">
            ...
            <div ref={numbersRef} className="grid grid-cols-3 gap-8">
              <div>
                ...
                <div className="font-mono text-xs text-white/50 uppercase tracking-wider">Core Services</div>
              </div>
              <div>
                <div className="font-serif text-4xl md:text-5xl text-primary mb-2">
                  <span className="stat-num">100</span>%
                </div>
                <div className="font-mono text-xs text-white/50 uppercase tracking-wider">Revenue-Focused</div>
              </div>
              <div>
                <div className="font-serif text-4xl md:text-5xl text-primary mb-2">
                  <span className="stat-num">24</span>/7
                </div>
                <div className="font-mono text-xs text-white/50 uppercase tracking-wider">AI Systems Active</div>
              </div>
            </div>
          </div>
